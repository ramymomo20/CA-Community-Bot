    ...
    try:
        ...
        for line_num, row in enumerate(rows, 1):
            ...
            try:
                ...
                # If Discord already linked, allow update so we can normalize legacy steam ids.
                existing_by_discord = await bot.db.players.get_player_by_discord_id(discord_id)
